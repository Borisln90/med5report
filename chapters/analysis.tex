...
The chromosomes which contains an array of genes is an abstract representation of data. Thus the chromosomes and genes must be encoded in some way, dependent on the problem. There are several ways that chromosomes can be encoded. Some of the encoding methods are listed by Obitko, 1998 \cite{Marek1998}

The types of encoding data range from strings of values, binary data, object trees and  number sequences.
