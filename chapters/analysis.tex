...
Furthermore we account for the formulation of fixed behaviours in section XX, and find the specific game features that represents itself as our interpretation of finite state machine.\\
Lastly, we find that interpretation of player performance is problem dependant, and the actual assessment will be accounted for in the design chapter, see chapter XX.